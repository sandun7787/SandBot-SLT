...
import static com.example.san.MyUtils.temporaryEmotion;
...
public class HandShake extends TopBaseActivity {
    ...
    public void firstMeeting() {
        ...
        //self presentation
        speechManager.startSpeak("I am sanbot", MySettings.getSpeakDefaultOption());
        ...
        incitement.postDelayed(new Runnable() {
            @Override
            public void run() {
                speechManager.startSpeak("come on", MySettings.getSpeakDefaultOption());
                //change image
    ...
    public void shakeHand() {
        ...
        */
        ...
        speechManager.startSpeak("glad to meet you", MySettings.getSpeakDefaultOption());
        concludeSpeak(speechManager);

        //starts dialog activity
        Intent myIntent = new Intent(HandShake.this, MotionActivity.class);
    ...
    public void timeWaitingExpired() {
        ...
        //sad sentence
        speechManager.startSpeak("no hand shake", MySettings.getSpeakDefaultOption());
        concludeSpeak(speechManager);
    ...
    public void updateHandshakes() {
        handshakes.setText("hand shake" + " " + MySettings.getHandshakes());
    }
}
